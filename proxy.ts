...
export const config={matcher:["/admin/:path*","/api/vrm-lookup","/api/hpi-test","/api/opportunities/:path*","/api/retail-check/:path*","/api/retail-history/:path*","/api/scanner-status/:path*","/api/run-opportunity-scan","/api/makes/:path*","/api/models/:path*","/api/stock/:path*"]};
