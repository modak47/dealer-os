...
const items=[["Overview","/admin/dashboard"],["Stock","/admin/stock"],["Leads","/admin/leads"],["Customers","/admin/customers"],["Sales channels","/admin/sales-channels"],["Settings","/admin/settings"]];
