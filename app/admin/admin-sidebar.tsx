...
const items=[["Overview","/admin/dashboard"],["Stock","/admin/stock"],["New Sale","/admin/sales/new"],["Invoices","/admin/accounts/invoices"],["Opportunities","/admin/opportunities"],["Retail Checker","/admin/retail-check"],["VRM Lookup","/admin/vrm-lookup"],["Leads","/admin/leads"],["Customers","/admin/customers"],["Sales channels","/admin/sales-channels"],["Settings","/admin/settings"]];
