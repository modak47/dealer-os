...
const groups: NavGroup[] = [
  { name: "Overview", key: "overview", items: [{ name: "Overview", href: "/admin/dashboard", icon: "O" }, { name: "Automations", href: "/admin/automations", icon: "A" }, { name: "Settings", href: "/admin/settings", icon: "*" }, { name: "Reservation Extras", href: "/admin/settings/reservation-extras", icon: "R" }, { name: "Website SEO", href: "/admin/settings/website-pages", icon: "W" }] },
  { name: "Sales", key: "sales", items: [{ name: "Stock", href: "/admin/stock", icon: "S" }, { name: "Social Automation", href: "/admin/social-automation", icon: "M" }, { name: "Customers", href: "/admin/customers", icon: "C" }, { name: "New Sale", href: "/admin/sales/new", icon: "N" }, { name: "Sales Pipeline", href: "/admin/sales", icon: "P" }, { name: "Invoices", href: "/admin/accounts/invoices", icon: "I" }, { name: "Book In", href: "/admin/stock/book-in", icon: "B" }, { name: "Financial Ledger", href: "/admin/ledger", icon: "L" }, { name: "Stock Ledger", href: "/admin/stock-ledger", icon: "$" }, { name: "Shadow Mode", href: "/admin/settings/shadow-mode", icon: "T" }, { name: "Dealer5 Shadow", href: "/admin/settings/dealer5-shadow", icon: "D" }] },
  ...
  { name: "Leads", key: "leads", items: [{ name: "Leads", href: "/admin/leads", icon: "L" }, { name: "Website Leads", href: "/website-leads", icon: "W" }, { name: "Dealer Contacts", href: "/dealer-contacts", icon: "D" }, { name: "Dealer Portal", href: "/admin/dealer-portal", icon: "P" }] },
];
