...
const groups: NavGroup[] = [
  { name: "Overview", key: "overview", items: [{ name: "Overview", href: "/admin/dashboard", icon: "O" }, { name: "Automations", href: "/admin/automations", icon: "A" }, { name: "Settings", href: "/admin/settings", icon: "*" }, { name: "Website SEO", href: "/admin/settings/website-pages", icon: "W" }] },
