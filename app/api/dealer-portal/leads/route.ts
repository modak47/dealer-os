...
function visualDealerPortalFixture() {
  ...
  const lead = {
    ...
    image2: "https://images.unsplash.com/photo-1558981033-0f0309284409?auto=format&fit=crop&w=1100&q=80",
    image3: null,
    image4: null,
    image5: null,
    image6: null,
    ...
    resolved_images: [
      ...
      "https://images.unsplash.com/photo-1558981033-0f0309284409?auto=format&fit=crop&w=1100&q=80",
    ],
    owner: null,
    spare_keys: null,
  ...
  const claimedLead = {
    ...
    mileage: "6000",
    price: "3000",
    portal_distance_miles: 34,
    portal_distance_label: "34 miles from your dealership",
    portal_location_label: "Brighton",
    location_town: "Brighton",
    portal_claim_id: "visual-claim-active",
    portal_claim_status: "attempting_contact",
    customer_unlocked: true,
    fname: "Keeleigh",
    lname: "Humphrey",
    email: "keeleigh.humphrey@example.com",
    phone: "07809137228",
    postcode: "RG17 9XG",
    ...
    portal_vehicle_check: {
      ...check,
      mot_expiry: "13 Apr 2026",
      details: check.details.map(item => item.label === "Registration" ? { ...item, value: "RJ17YSN" } : item),
      mot_history: [
        { date: "2025-04-14", status: "pass", mileage: 3895, expiry: "2026-04-13", details: [] },
        { date: "2023-08-24", status: "pass", mileage: 2998, expiry: "2024-08-23", details: [] },
        { date: "2023-03-29", status: "pass", mileage: 2880, expiry: "2024-03-28", details: [] },
        { date: "2023-03-29", status: "fail", mileage: 2880, expiry: null, details: ["Exhaust noisy", "Drive chain worn but not excessive"] },
        { date: "2021-03-03", status: "pass", mileage: 2877, expiry: "2022-03-02", details: [] },
      ],
      mileage_history: [
        { date: "2021", mileage: 2877, source: "MOT" },
        { date: "2023", mileage: 2880, source: "MOT" },
        { date: "2023", mileage: 2998, source: "MOT" },
        { date: "2025", mileage: 3895, source: "MOT" },
      ],
      seller_mileage: 6000,
    },
  } as DealerVisibleLead;
  const purchasedLead = {
    ...
    mileage: "5142",
    price: null,
    portal_claim_id: "visual-claim-purchased",
    portal_claim_status: "purchased",
    portal_location_label: "Derby",
    portal_distance_miles: 153.4,
    portal_distance_label: "153.4 miles from your dealership",
    portal_notes: [
      { id: "visual-note-2", website_lead_id: 9003, claim_id: "visual-claim-purchased", dealer_account_id: dealer.id, dealer_user_id: null, note_type: "status", body: "Purchase reported. Collection booked with seller.", created_at: "2026-08-17T14:20:00.000Z" },
    ],
  } as DealerVisibleLead;
  const lostLead = {
    ...claimedLead,
    ...
    mileage: "6802",
    price: "4250",
    portal_claim_id: "visual-claim-lost",
    portal_claim_status: "lost",
    portal_lost_reason: "Couldn’t agree price",
    portal_attribution_expires_at: "2026-10-15T23:59:59.000Z",
    portal_location_label: "Reading",
    portal_distance_miles: 62,
    portal_distance_label: "62 miles from your dealership",
    portal_notes: [
