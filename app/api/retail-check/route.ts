...
export async function POST(request:Request){
  try{
    ...
    const data=await createRetailCheck({registration:body.registration,make:body.make,model:body.model,year:body.year,mileage:body.mileage,askingPrice:body.askingPrice,requestId:body.requestId,derivative:body.derivative,derivativeId:body.derivativeId,autotraderVehicleId:body.autotraderVehicleId,autotraderTaxonomyData:body.autotraderTaxonomyData});
    if(body.leadId){
