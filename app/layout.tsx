...
export const metadata:Metadata={title:{default:`${dealership.dealerName} | Premium Used Motorcycles`,template:`%s | ${dealership.dealerName}`},description:dealership.heroSubtitle};
