...
export const metadata:Metadata={metadataBase:new URL(siteUrl()),title:{default:`${dealership.dealerName} | Premium Used Motorcycles`,template:`%s | ${dealership.dealerName}`},description:dealership.heroSubtitle,icons:{icon:[{url:"/favicon-yesmoto.png",type:"image/png"}],shortcut:"/favicon-yesmoto.png",apple:"/favicon-yesmoto.png"}};
