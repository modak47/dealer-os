...
export default async function Detail({params}:{params:Promise<{id:string}>}){
  ...
  const subtitle=[bike.bodyStyle||bike.category,bike.mileage,bike.engineCc>0?`${bike.engineCc.toLocaleString("en-GB")}cc`:"",bike.transmission].filter(Boolean).join(" · ");
