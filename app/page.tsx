...
const inspectionItems=[
  {title:"Engine & drivetrain",image:"https://images.unsplash.com/photo-1683456062177-f5ddaf6b9f20?auto=format&fit=crop&w=1100&q=86",position:"center 48%",copy:"We inspect engine performance, clutch operation, gearbox, cooling system, fluid levels and carry out a full road test."},
  {title:"Brakes, suspension & steering",image:"https://images.unsplash.com/photo-1707847828334-faf337661922?auto=format&fit=crop&w=1100&q=86",position:"center 50%",copy:"Brake discs, pads, suspension components, wheel bearings, steering and handling are checked for safe, confident riding."},
  {title:"Electrical & safety systems",image:"https://images.unsplash.com/photo-1668425104412-0c176d33e986?auto=format&fit=crop&w=1100&q=86",position:"center 45%",copy:"Lights, indicators, dashboard, switches, battery, charging system and rider aids are tested before sale."},
  {title:"Tyres & final preparation",image:"https://images.unsplash.com/photo-1711042818431-1ce87053c080?auto=format&fit=crop&w=1100&q=86",position:"center 50%",copy:"Tyres, chain or belt drive, final checks and professional cleaning are completed before handover or delivery."},
];
